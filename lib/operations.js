...
export const seedOp = defineOp({
  ...
  input: z.object({
    ...
    openapi: z
      .string()
      .optional()
      .describe("URL or file path to OpenAPI 3.x spec (required for entity schema discovery)"),
    auth: z
      .string()
      .optional()
  ...
  handler: async ({ plan, openapi, auth, dryRun }) => {
    return executeSeed(plan, { openapi, auth, dryRun, faker });
  },
});
